...
#include <QMessageBox>
#include <iostream>
#include "../include/oroca_ros_tutorials_gui/main_window.hpp"
...
void MainWindow::updateResultLineEdit(int srv_response) {
   ui.response_result_lineEdit->setText(QString::number(srv_response));
}


void MainWindow::changeOperator() {
...
void MainWindow::ReadSettings() {
    QSettings settings("Qt-Ros Package", "oroca_ros_tutorials_gui");
...
void oroca_ros_tutorials_gui::MainWindow::on_send_pushButton_clicked(bool checked)
{
